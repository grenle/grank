...
|-------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------|
| Creating procedures when logic and order procedures do                              | N-ary comparisons (~<~ and friends), ~or~, ~and~ can be used to easily capture /number between/ and /value of exp of default if value nil/ ideas. How well does this translate in other languages (facilities *and* culture) |
|-------------------------------------------------------------------------------------+--------------------------------------------------------------------------------------------------------|
